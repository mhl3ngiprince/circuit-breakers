...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      icon: Brain,
      github: 'https://github.com/mhl3ngiprince/Medical-Diagnosis-Assistant',
      demo: 'https://mhl3ngiprince.github.io/Medical-Diagnosis-Assistant/',
      status: 'In Progress',
    },
    {
      ...
      icon: Cpu,
      github: 'https://github.com/mhl3ngiprince/-Autonomous-Robot-Navigation',
      demo: 'https://mhl3ngiprince.github.io/-Autonomous-Robot-Navigation/',
      status: 'In Progress',
    },
  ];
